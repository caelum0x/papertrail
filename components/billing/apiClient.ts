...
// Client-side fetch helpers for the billing module. Sends the active org id
// (persisted by the console layout) in the x-org-id header so withOrg scopes to
// the correct org, and unwraps the { success, data, error, meta } envelope.
...
// Formats a cents amount as USD (e.g. 4900 -> "$49.00"). Pure, shared by pages.
