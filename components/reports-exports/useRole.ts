...
// reports/exports pages can gate mutating actions (create report, run export,
// delete) to editor+. Self-contained to keep the module decoupled from siblings.
...
export interface RoleState {
  role: string | null;
  loading: boolean;
  // Can the user create reports / run exports / delete (editor and above).
  canEdit: boolean;
}
