...
// Reusable page header for the Templates module: title + subtitle on the left,
// up to two actions on the right. Shared across the grid, detail, and category
// pages so headers stay visually consistent.
