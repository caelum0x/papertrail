// Client-side fetch helpers for the Reference manager console pages. Reads the
// active org id from localStorage (set by the console layout's org switcher) and
