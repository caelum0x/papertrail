...
import type { SynthesisVerdict } from "./types";

// Verdict banner: color-codes the deterministic claim-vs-pool verdict and shows
// the rationale plus the claimed vs pooled reduction side by side.
