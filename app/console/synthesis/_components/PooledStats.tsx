...
// Numeric summary of the pooled result: fixed & random estimates, heterogeneity
// (I²/tau²/Q), and the prediction interval — the reproducible numbers behind the
// forest plot. Presentation only; every value comes from the API response.

interface PooledStatsProps {
...
export function PooledStats({ pooled }: PooledStatsProps) {
